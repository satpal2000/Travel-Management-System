...
public class CheckHotel extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run() {
        String[] text = new String[]{"RJ Hotel","Taj Hotel","Four Session Hotel","Raddison Hotel","Oberio Hotel","The bay Club Hotel","Five Star Hotel","Happy Morning Hotel","Mountain View Hotel","Sky Motel"};
        try{
            for(int i = 0; i <=9 ; i++){
    ...
    CheckHotel(){
        ...
        caption = new JLabel();
        caption.setBounds(30,420,1000,70);
